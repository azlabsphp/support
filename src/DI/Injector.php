...
{
    use BindingsProvidersAware, BindginsResolversAware;
    ...
    private function getAutoResolvableClasses($list)
    {
        foreach ($list as $abstract) {
            ...
            if (!in_array(AutoResolve::class, $attributes)) {
                continue;
            }
            yield $abstract;
        }
    ...
    {
        return function (self $container, $parameters = []) use ($abstract, $concrete) {
